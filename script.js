const apiUrl = 'http://testchatbot224com.local/wp-json/myapi/v1/chat-bot/';
const botConfigurationUrl = 'http://testchatbot224com.local/wp-json/myapi/v1/chat-bot-config';
    ...
    try {
        ...
        if (response.ok) {
            ...
            if (!data.success) {
                ...
                lwhOpenCbotshowPopup('Oops! Something went wrong!1', '#991a1a');
                throw new Error("Something went wrong. Please Try Again!");
            }
        } else {
            lwhOpenCbotshowPopup('Oops! Something went wrong!2', '#991a1a');
        ...
        lwhOpenCbotremoveTypingAnimation();
        lwhOpenCbotshowPopup('Oops! Something went wrong!3', '#991a1a');
...
async function lwhOpenCbotfetchBotConfiguration() {
    ...
    try {
        ...
        if (botResponse.ok) {
            ...
            document.querySelector(".lwh-open-cbot .loading").style.display = 'none';
            lwhOpenCbotshowPopup('Oops! Something went wrong!4', '#991a1a');
            throw new Error("Request failed. Please try again!");
        }
    } catch (error) {
        lwhOpenCbotshowPopup('Oops! Something went wrong!5', '#991a1a');
        button.disabled = true
        console.error('There was a problem with the fetch operation:', error);
        return;
    }
